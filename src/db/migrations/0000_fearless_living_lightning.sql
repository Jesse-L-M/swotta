...
ALTER TABLE "classes" ADD CONSTRAINT "classes_qualification_version_id_qualification_versions_id_fk" FOREIGN KEY ("qualification_version_id") REFERENCES "public"."qualification_versions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "learner_qualifications" ADD CONSTRAINT "learner_qualifications_qualification_version_id_qualification_versions_id_fk" FOREIGN KEY ("qualification_version_id") REFERENCES "public"."qualification_versions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "confidence_events" ADD CONSTRAINT "confidence_events_block_attempt_id_block_attempts_id_fk" FOREIGN KEY ("block_attempt_id") REFERENCES "public"."block_attempts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "misconception_events" ADD CONSTRAINT "misconception_events_block_attempt_id_block_attempts_id_fk" FOREIGN KEY ("block_attempt_id") REFERENCES "public"."block_attempts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "retention_events" ADD CONSTRAINT "retention_events_block_attempt_id_block_attempts_id_fk" FOREIGN KEY ("block_attempt_id") REFERENCES "public"."block_attempts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "study_sessions" ADD CONSTRAINT "study_sessions_block_id_study_blocks_id_fk" FOREIGN KEY ("block_id") REFERENCES "public"."study_blocks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint

...
type E2EFixtureUid = (typeof e2eFixtureUids)[E2EFixtureKind];

const e2eFixtureUidSet = new Set<string>(Object.values(e2eFixtureUids));
...
function isE2EFixtureUid(uid: string): uid is E2EFixtureUid {
  return e2eFixtureUidSet.has(uid);
}
...
export function verifyE2ESessionCookie(
  ...
  if (!payload || !isE2EFixtureUid(payload.uid)) {
    return null;
  }
